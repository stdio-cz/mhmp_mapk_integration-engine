...
import { HomeportOutOfLocationsTransformation } from "../../../src/modules/sharedbikes";
...
describe("HomeportOutOfLocationsTransformation", () => {
    ...
    beforeEach(async () => {
        ...
        transformation = new HomeportOutOfLocationsTransformation();
        const buffer = await readFile(__dirname + "/../../data/homeport_outoflocations_sharedbikes-datasource.json");
    ...
    it("should has name", async () => {
        ...
        expect(transformation.name).is.equal("HomeportSharedBikesOutOfLocations");
    });
