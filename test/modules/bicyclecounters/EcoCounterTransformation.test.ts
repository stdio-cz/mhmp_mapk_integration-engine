...
import "mocha";
import { EcoCounterTransformation } from "../../../src/modules/bicyclecounters";
...
describe("EcoCounterTransformation", () => {
    ...
    before(() => {
        locationsValidator = new Validator(BicycleCounters.ecoCounter.name + "LocModelValidator",
            BicycleCounters.locations.outputMongooseSchemaObject);
        directionsValidator = new Validator(BicycleCounters.ecoCounter.name + "DirModelValidator",
            BicycleCounters.directions.outputMongooseSchemaObject);
    });

    beforeEach(async () => {
        transformation = new EcoCounterTransformation();
    ...
    it("should has name", async () => {
        ...
        expect(transformation.name).is.equal("EcoCounterBicycleCounters");
    });
