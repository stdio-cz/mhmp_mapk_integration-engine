...
import IceGatewayStreetLampsModel from "../../src/models/IceGatewayStreetLampsModel";
...
describe("IceGatewayStreetLampsModel", () => {

    let model: IceGatewayStreetLampsModel;
    let testData;
    let testId;

    before(async () => {
        await mongooseConnection;
        model = new IceGatewayStreetLampsModel();
        const buffer = await readFile(__dirname + "/../data/icegatewaystreetlamps-transformed.json");
