...
import IceGatewaySensorsModel from "../../src/models/IceGatewaySensorsModel";
...
describe("IceGatewaySensorsModel", () => {

    let model: IceGatewaySensorsModel;
    let testData;
    let testId;

    before(async () => {
        await mongooseConnection;
        model = new IceGatewaySensorsModel();
    ...
    describe("SaveToDb", () => {
        ...
        it("should saves test data to DB", async () => {
            ...
            delete toTest._id;
            toTest.properties.sensors = toTest.properties.sensors.map((s) => { delete s._id; return s; });
