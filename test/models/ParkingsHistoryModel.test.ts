...
import ParkingsHistoryModel from "../../src/models/ParkingsHistoryModel";
...
describe("ParkingsHistoryModel", () => {

    let model: ParkingsHistoryModel;
    let testData;
    let testId;

    before(async () => {
        await mongooseConnection;
        model = new ParkingsHistoryModel();
        const buffer = await readFile(__dirname + "/../data/parkings_history-transformed.json");
