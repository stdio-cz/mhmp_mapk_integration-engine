...
import TrafficCamerasHistoryTransformation from "../transformations/TrafficCamerasHistoryTransformation";
...
export default class TrafficCamerasWorker extends BaseWorker {
    ...
    private historyTransformation: TrafficCamerasHistoryTransformation;
    ...
    constructor() {
        ...
        this.historyTransformation = new TrafficCamerasHistoryTransformation();
