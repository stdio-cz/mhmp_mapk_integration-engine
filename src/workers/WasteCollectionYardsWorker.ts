...
import WasteCollectionYardsTransformation from "../transformations/WasteCollectionYardsTransformation";
import BaseWorker from "./BaseWorker";

const config = require("../config/ConfigLoader");

export default class WasteCollectionYardsWorker extends BaseWorker {
