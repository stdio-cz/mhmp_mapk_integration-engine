...
import MunicipalAuthoritiesTransformation from "../transformations/MunicipalAuthoritiesTransformation";
import BaseWorker from "./BaseWorker";

const config = require("../config/ConfigLoader");

export default class MunicipalAuthoritiesWorker extends BaseWorker {
