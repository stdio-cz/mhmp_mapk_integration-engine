...
import { CityDistricts, SortedWasteStations } from "data-platform-schema-definitions";
...
import IPRSortedWasteStationsTransformation from "../transformations/IPRSortedWasteStationsTransformation";
import OICTSortedWasteStationsTransformation from "../transformations/OICTSortedWasteStationsTransformation";
import POTEXSortedWasteStationsTransformation from "../transformations/POTEXSortedWasteStationsTransformation";
import BaseWorker from "./BaseWorker";

const config = require("../config/ConfigLoader");
const _ = require("underscore");

export default class SortedWasteStationsWorker extends BaseWorker {
